...
S_exc2exc = Synapses(exc_neurons_control, exc_neurons_control)
S_exc2exc.connect('i != j', p = 0.5)

S_exc2inh = Synapses(exc_neurons_control, inh_neurons_control)
S_exc2inh.connect('i != j', p = 0.5)

S_inh2exc = Synapses(inh_neurons_control, exc_neurons_control)
S_inh2exc.connect('i != j', p = 0.5)

S_inh2inh = Synapses(inh_neurons_control, inh_neurons_control)
